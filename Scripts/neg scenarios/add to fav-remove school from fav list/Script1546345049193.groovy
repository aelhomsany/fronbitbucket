...
WebUI.setText(findTestObject('add_event/username'), 'student@yahoo.com')
...
not_run: WebUI.click(findTestObject('add to fav/schools_btn'))

not_run: WebUI.click(findTestObject('add to fav/yahiaschool_btn'))
